...
def train_window_pretrainer(model, x_train, y_train, x_val, y_val, checkpoint_path, class_weights=None):
    """Addestra l'encoder a riconoscere pattern motori significativi."""
    ...
    callbacks = [
        ...
        tf.keras.callbacks.EarlyStopping(monitor="val_f1_score", mode="max", patience=10, restore_best_weights=True)
    ]
